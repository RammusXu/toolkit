...
ref: https://cloud.google.com/kubernetes-engine/docs/release-notes#new_features_17

GKE is using kube-dns rather than core-dns. No idea why they are doing this.
